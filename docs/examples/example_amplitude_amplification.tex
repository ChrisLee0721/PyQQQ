...
振幅放大可以在无序数据库中搜索目标，提供 $O(\sqrt{N})$ 的二次加速。经典方法需要 $O(N)$ 次查询。

\subsection{组合优化问题}

振幅放大可以用于求解旅行商问题、调度问题等组合优化问题。经典方法需要遍历所有解，振幅放大可以更快找到最优解。

\subsection{密码学分析}

振幅放大可以用于搜索密钥空间、破解哈希函数。经典方法需要指数时间，振幅放大可以提供二次加速。

\subsection{量子算法基础}

振幅放大是 Grover 搜索、量子计数、量子最小值查找等算法的基础。理解振幅放大是学习更高级量子算法的前提。
