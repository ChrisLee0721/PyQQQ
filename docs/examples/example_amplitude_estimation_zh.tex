...
振幅估计可以精确计算量子算法的成功概率，而不需要多次运行。这对于优化算法参数、评估算法效率非常重要。

\subsection{量子优化问题求解}

振幅估计可以估计组合优化问题中最优解的数量和位置。这对于决策支持、风险评估非常重要。

\subsection{量子化学计算}

振幅估计可以用于估计分子基态能量、计算反应速率等。振幅估计可以提供比经典方法更精确的结果。

\subsection{金融风险评估}

振幅估计可以用于估计投资组合的风险价值（VaR）、计算期权价格等。振幅估计可以处理高维概率分布。
