...
Jordan-Wigner 变换将分子的费米子哈密顿量映射到量子比特，使得量子计算机可以模拟分子系统。这是量子化学模拟的基础。

\subsection{材料电子结构计算}

Jordan-Wigner 变换将材料的费米子哈密顿量映射到量子比特，使得量子计算机可以精确计算材料的电子结构。

\subsection{量子多体系统模拟}

Jordan-Wigner 变换将 Hubbard 模型等量子多体系统映射到量子比特，使得量子计算机可以模拟这些经典方法无法处理的系统。

\subsection{量子算法设计}

Jordan-Wigner 变换是 VQE、QPE 等量子算法的基础，用于构造量子电路和准备初始态。
